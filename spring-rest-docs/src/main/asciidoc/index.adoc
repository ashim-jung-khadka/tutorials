= Spring REST Docs Getting Started Guide
Ashim Jung Khadka;
:doctype: book
:icons: font
...
Spring REST Docs is a simple solution with rest api documentation ...
...
[[overview-http-verbs]]
== HTTP verbs
Spring REST Docs tries to adhere as closely as possible to standard HTTP and REST conventions in its
use of HTTP verbs.
|===
| Verb | Usage
