...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleAuthenticationCredentialsNotFoundException(
		...
		//
		final ApiError apiError = new ApiError(HttpStatus.UNAUTHORIZED, "access unauthorized",
				"access fobiden");
		return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
	}
	...
	public ResponseEntity<Object> handleUsernameNotFoundException(final UsernameNotFoundException ex,
		...
		logger.debug("error", ex);
		//
		final ApiError apiError = new ApiError(HttpStatus.UNAUTHORIZED, "Unauthorized access",
				"Unauthorized access");
		return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
	}
	...
	public ResponseEntity<Object> handleTokenNotValidException(final TokenNotValidException ex,
			final WebRequest request) {

		logger.info(ex.getClass().getName());
		logger.debug("error", ex);
		//
		final ApiError apiError = new ApiError(ex.getStatus(), ex.getMessage(),
				ex.getMessage());
		return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
	}
